...
public class CoordinatorLayoutPageFragmentCover extends Fragment {
    ...
    public static CoordinatorLayoutPageFragmentCover newInstance(int page) {
        Bundle args = new Bundle();
        args.putInt(ARG_PAGE, page);
        CoordinatorLayoutPageFragmentCover pageFragment = new CoordinatorLayoutPageFragmentCover();
