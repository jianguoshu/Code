package com.douzi.dd.demo.GridLayoutTest;
...
public class GridLayoutActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getChildView(R.drawable.creditduihuan, "积分换搜豆呀", mGridLayout, 0, 0);
        addDivider(mGridLayout, 1, 0);
        getChildView(R.drawable.creditshop, "积分商城", mGridLayout, 2, 0);
        addDivider(mGridLayout, 3, 0);
        getChildView(R.drawable.creditchoujiang, "抽奖", mGridLayout, 5, 0);
        getChildView(R.drawable.creditchoujiang, "抽奖", mGridLayout, 0, 1);
