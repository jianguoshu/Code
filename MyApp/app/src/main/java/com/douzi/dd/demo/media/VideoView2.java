...
public class VideoView2 extends SurfaceView implements MediaPlayerControl {
    ...
    private Pair<Integer, Integer> measureByScaleMode(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (mVideoWidth > 0 && mVideoHeight > 0) {
            ...
            switch (scaleMode) {
                case ScaleMode.CENTER_CROP:
                    if (1.0f * mVideoWidth / mVideoHeight > 1.0f * widthSpecSize / heightSpecSize) {
                        width = (int) (1.0f * mVideoWidth / mVideoHeight * heightSpecSize);
                        height = heightSpecSize;
                    } else {
                        width = widthSpecSize;
                        height = (int) (1.0f * mVideoHeight / mVideoWidth * widthSpecSize);
                    }
                    break;
