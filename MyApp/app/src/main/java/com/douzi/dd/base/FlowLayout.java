...
public class FlowLayout extends ViewGroup {
    ...
    protected FlowLayoutHelper.MeasureResult measureResult = new FlowLayoutHelper.MeasureResult();
    ...
    public FlowLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        setMaxLine(ta.getInt(R.styleable.FlowLayout_maxLine, Integer.MAX_VALUE));
        ta.recycle();
    }
    ...
    protected LayoutParams generateLayoutParams(ViewGroup.LayoutParams p) {
        ...
        if (p instanceof ViewGroup.MarginLayoutParams) {
            return new FlowLayout.LayoutParams((ViewGroup.MarginLayoutParams) p);
        } else {
