...
public class PaaActivity3 extends BaseActivity {

    private WebView mWebView;
    private BottomSheetBehavior behavior;

    public static void startAct(Context context) {
        Intent intent = new Intent(context, PaaActivity3.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_paa_layout3);
        ...
        behavior = (BottomSheetBehavior) ((CoordinatorLayout.LayoutParams) findViewById(R.id.bottom_sheet_view).getLayoutParams()).getBehavior();
...
//                behavior.setState(BottomSheetBehavior.STATE_HALF_EXPANDED);
        ...
        findViewById(R.id.btn_collapsed).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
        ...
        findViewById(R.id.btn_cover_hide).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
