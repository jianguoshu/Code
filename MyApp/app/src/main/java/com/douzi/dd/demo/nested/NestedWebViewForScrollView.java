...
public class NestedWebViewForScrollView extends WebView implements NestedScrollingChild {
    private int mLastY;
    private int mDownY;
    ...
    public NestedWebViewForScrollView(Context context) {
        this(context, null);
    }

    public NestedWebViewForScrollView(Context context, AttributeSet attrs) {
        this(context, attrs, android.R.attr.webViewStyle);
    }

    public NestedWebViewForScrollView(Context context, AttributeSet attrs, int defStyleAttr) {
